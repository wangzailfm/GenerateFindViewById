    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        val mSelectedText: String? = mEditor.selectionModel.selectedText ?: let {
            Messages.showInputDialog(project,
                ...
                mEditor.showPopupBalloon(Constant.actions.SELECTED_ERROR_NO_NAME, popupTime)
                return
            }
        }
        ...
        val psiClass = mEditor getTargetClass psiFile ?: let {
            mEditor.showPopupBalloon(Constant.actions.SELECTED_ERROR_NO_POINT, popupTime)
            return
        }
        // 判断是否有onCreate方法
        ...
        if (psiFiles.isEmpty()) {
            mEditor.showPopupBalloon(Constant.actions.SELECTED_ERROR_NO_SELECTED, popupTime)
            return
        }
        ...
        if (elements.size == 0) {
            mEditor.showPopupBalloon(Constant.actions.SELECTED_ERROR_NO_ID, popupTime)
            return
        }
